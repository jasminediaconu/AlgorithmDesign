...
public class OptimalDecisionTree {
    ...
    public static int decisionTree(int d, List<Pair<Integer[], Integer>> samples) {
        ...
        List<Pair<Integer[], Integer>> leftSide = samples.subList(0, middle);
        List<Pair<Integer[], Integer>> rightSide = samples.subList(middle, samples.size());
