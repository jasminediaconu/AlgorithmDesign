package DivindeAndConquer;

import main.DivideAndConquer.CountInversions.CountInversions;
import main.DivideAndConquer.ExploringAMaze.BinaryTree;
import main.DivideAndConquer.ExploringAMaze.ExploringAMaze;
import main.DivideAndConquer.SmallIsBetter.Equation;
import main.DivideAndConquer.SmallIsBetter.QuadraticEquation;
import main.DivideAndConquer.SmallIsBetter.SmallIsBetter;
import main.DivideAndConquer.SnuggleInTight.Point;
import main.DivideAndConquer.SnuggleInTight.SnuggleInTight;
import main.DivideAndConquer.SortingThroughMerging.SortingThroughMerging;
...
public class Tests {
    ...
    public void smallIsBetter2() {
        Equation eq1 = new QuadraticEquation(0, 28, -3240);
        Equation eq2 = new QuadraticEquation(0, 6, -106);
